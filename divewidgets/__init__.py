...
from .magic import DIVEMagics, OPTMMagics
from .widget import JSWidget, create_JSXGraph, create_mermaid, create_flowchart, OPTMWidget, create_optm
...
def load_ipython_extension(ipython):
    ...
    ipython.register_magics(OPTMMagics)
